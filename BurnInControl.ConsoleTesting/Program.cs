...
MessagePacket<StationCommand> msgPacket = new MessagePacket<StationCommand>() {
    Prefix = StationMsgPrefix.CommandPrefix,
    Packet = StationCommand.ToggleHeat
};

Console.WriteLine(JsonSerializer.Serialize(msgPacket));


#region GeneralTestingAndTasks
    //await CloneDatabase();
