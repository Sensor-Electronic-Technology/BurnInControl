...
public class HeaterControllerConfig:IPacket,IBurnStationConfiguration {
    ...
    public HeaterControllerConfig() {
        ...
        PidConfiguration pidConfig1 = new PidConfiguration(242.21,1868.81,128.49);
        PidConfiguration pidConfig2 = new PidConfiguration(765.77,1345.82,604.67);
        PidConfiguration pidConfig3 = new PidConfiguration(179.95,2216.84,81.62);
