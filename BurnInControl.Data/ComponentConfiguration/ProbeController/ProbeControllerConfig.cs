...
public class ProbeControllerConfig:IPacket,IBurnStationConfiguration {
    ...
    public ProbeControllerConfig() {
        ...
        this.ProbeConfigurations = new[] {
            ...
            new ProbeConfig(3,new VoltageSensorConfig(StationAnalogPin.A02.Value, 0.1), new CurrentSensorConfig(StationAnalogPin.A12.Value, 0.1)),
            new ProbeConfig(4,new VoltageSensorConfig(StationAnalogPin.A03.Value, 0.1), new CurrentSensorConfig(StationAnalogPin.A13.Value, 0.1)),
            new ProbeConfig(5,new VoltageSensorConfig(StationAnalogPin.A04.Value, 0.1), new CurrentSensorConfig(StationAnalogPin.A14.Value, 0.1)),
            new ProbeConfig(6,new VoltageSensorConfig(StationAnalogPin.A05.Value, 0.1), new CurrentSensorConfig(StationAnalogPin.A15.Value, 0.1)),
        };
    }
}